...
Item {
    ...
    GridLayout {
        ...
        rowSpacing: screen.height * 0.019 //Kirigami.Units.smallSpacing
        columnSpacing: screen.width * 0.08 //Kirigami.Units.smallSpacing
    ...
    Component {
        ...
        Kirigami.Heading {
            ...
            horizontalAlignment: Qt.AlignLeft//temp.effectiveLayout(item)
