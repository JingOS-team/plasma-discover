...
HttpRequest &HttpRequest::removePublicQueryParams()
{
    m_isInsertPublic = false;
    return *this;
}
...
HttpResponse *HttpRequest::exec()
{
    ...
    log_debugger += "Type: " + QString(s_httpOperation[m_op]);
...
void HttpRequest::insertPublicQueryParams()
{
